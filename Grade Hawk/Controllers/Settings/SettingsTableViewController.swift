...
//        }
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        switch section { // keep eye on this
        case 0: return "Info"
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            UIApplication.shared.open(URL(string: "http://guestman360.github.io")!, options: [:], completionHandler: nil)
        case 2:
            UIApplication.shared.open(URL(string: "https://github.com/Guestman360")!, options: [:], completionHandler: nil)
        default:
            return
        }
//        if indexPath.section == 1 && indexPath.row == 0 && !GradePointPremium.isPurchased {
...
//                }
//            case 1:
//                UIApplication.shared.openURL(URL(string: "http://guestman360.github.io")!)
//            case 2:
//                UIApplication.shared.openURL(URL(string: "https://github.com/Guestman360")!)
//            default:
//                return
//            }
//        }
